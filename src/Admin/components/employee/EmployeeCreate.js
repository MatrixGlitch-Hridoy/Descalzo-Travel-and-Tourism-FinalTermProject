...
const submitEmployee= (e) =>{
  ...
  return (
    ...
    <h4>Add Employee
    <Link to="/employee" className="btn btn-primary btn-sm float-end">Enployee List</Link>
    </h4>
    ...
    <div className="form-group mb-3">
      ...
      <div className="form-group mb-3">
       <div>
          ...
          <button type="submit" className="btn btn-primary px-4 mt-2">AddEmployee</button>
       </form>
    </div>
